...
from dataloaders.MIT_dl import MITDataset, MITDataModule
...
def main():
    ...
    fine_tuner = SSLOnlineEval(z_dim=512, num_classes=305)
    fine_tuner.to_device = to_device

    # model = BasicMLP(config)
    # dataset = CustomDataset(config)
    # dm = MMXDataModule("data_processing/mmx_tensors_train.pkl","data_processing/mmx_tensors_val.pkl", config)
    dm = MITDataModule("data_processing/scene_temporal/mit_tensors_train.pkl","data_processing/scene_temporal/mit_tensors_train.pkl", config)
